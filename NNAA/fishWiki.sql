/*
 ...
 Source Schema         : fishwiki

 Target Server Type    : MySQL
 Target Server Version : 80035
 File Encoding         : 65001

 Date: 16/05/2024 14:39:51
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of config_info
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'fishNacos-8070', 'DEFAULT_GROUP', 'server:\r\n  port: 8070\r\nspring:\r\n  application:\r\n    name: fishNacos-8070\r\n  cloud:\r\n    # nacos????\r\n    nacos:\r\n      server-addr: 127.0.0.1:8848\r\nhystrix:\r\n  command:\r\n    default:\r\n      execution:\r\n        isolation:\r\n          thread:\r\n            timeoutInMilliseconds: 5000  # ?????????????\r\n  threadpool:\r\n    default:\r\n      coreSize: 10  # ??????????\r\n\r\n\r\n\r\n', 'be9f1c0e5c63f7aacf945f1ccb067250', '2024-05-16 01:42:31', '2024-05-16 01:42:31', NULL, '127.0.0.1', '', '448a9a09-956f-4937-ab03-5900d6075a60', 'fishNacos-8070的配置', NULL, NULL, 'yaml', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (0, 1, 'fishNacos-8070', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8070\r\nspring:\r\n  application:\r\n    name: fishNacos-8070\r\n  cloud:\r\n    # nacos????\r\n    nacos:\r\n      server-addr: 127.0.0.1:8848\r\nhystrix:\r\n  command:\r\n    default:\r\n      execution:\r\n        isolation:\r\n          thread:\r\n            timeoutInMilliseconds: 5000  # ?????????????\r\n  threadpool:\r\n    default:\r\n      coreSize: 10  # ??????????\r\n\r\n\r\n\r\n', 'be9f1c0e5c63f7aacf945f1ccb067250', '2024-05-16 09:42:31', '2024-05-16 01:42:31', NULL, '127.0.0.1', 'I', '448a9a09-956f-4937-ab03-5900d6075a60', '');
...
-- ----------------------------
INSERT INTO `tenant_info` VALUES (1, '1', '448a9a09-956f-4937-ab03-5900d6075a60', 'dev', '开发', 'nacos', 1715823668640, 1715823677522);
